...
fun SignUpScreen(navController: NavHostController) {
    ...
    Column(
        ...
        SignUpGoogleLoginButton(navController)
...
@Composable
fun SignUpGoogleLoginButton(navController: NavHostController) {
    Row(
    ...
    Row() {
        Text(text = "Already have an account ?", color = Color.White, style = TextStyle(fontSize = 14.sp, fontWeight = FontWeight.Normal))
        ClickableText(text = AnnotatedString("Login"), onClick = { navController.toLogin() },  style = TextStyle(fontSize = 14.sp, fontWeight = FontWeight.Bold,
            color = Color.Cyan
        ))
    }
}
...
@Composable
fun SignUpButton(onLoginButtonClicked: ()-> Unit) {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally,modifier = Modifier
        ...
        Button(onClick = onLoginButtonClicked, colors = ButtonDefaults.buttonColors(contentColor = Color(0xFF191584)),modifier = Modifier.width(250.dp), shape = RectangleShape) {
            Text(text = "SignUp", color = Color.White, style = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Bold))
        }
...
fun SignUpHeader() {
    Column(horizontalAlignment = Alignment.CenterHorizontally){
        Text(text = "Hello ! " , color = Color.White, style = TextStyle(fontSize = 30.sp, fontWeight = FontWeight.ExtraBold))
        Text(text = "Signup to get Started" ,color = Color.White, style = TextStyle(fontSize = 18.sp, fontWeight = FontWeight.SemiBold))
    }
}

@Composable
fun SignUpFields(email: String, passWord: String,onEmailChange: (String) -> Unit,onPasswordChange: (String) -> Unit,) {
